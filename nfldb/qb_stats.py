# -*- coding: utf-8 -*-
"""
Created on Sat May 13 22:08:56 2017

@author: Alan
Write QB stats to .csv
"""
...
position = 'QB'
limit = 60
sort_by = ['passing_yds', 'passing_tds', 'passing_att']
...
for year in years:
    for sort in sort_by:
        for ppr in ppr_rules:
            ...
            filepath = os.path.abspath(os.path.join(basepath, "..", "output/qb/top"+
